...
// gammes autorisées — doit rester cohérent avec la contrainte CHECK en base.
...
//
// Pourquoi une structure séparée de Service : on ne veut PAS qu'un client
...
// construction (c'est l'équivalent d'un serializer Django ou d'un DTO).
